...
class PCGrad():
    ...
    def _project_conflicting(self, grads, has_grads, shapes=None):
       ...
       # Gradient weights satisfy the Dirichlet distribution
        u_t=[[],[]]
        ...
        if self._reduction:
            merged_grad[shared] = torch.stack([g[shared]  # torch.stack connects tensors along a new dimension
    ...
    def _pack_grad(self, objectives):
        ...
        for obj in objectives:
            ...
            grad, shape, has_grad = self._retrieve_grad()  # Restore the gradients of two tasks
            grads.append(self._flatten_grad(grad, shape))  # Put each task gradient into a vector
