...
optimizer = optim.Adam(SegNet_MTAN.parameters(), lr=1e-4)        # . parameters() returns trainable parameters in the network as a generator (which can be viewed as a list)
...
# define dataset
dataset_path = opt.dataroot        # '--dataroot', default='nyuv2'
