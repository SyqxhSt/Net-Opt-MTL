...
class VMSANet(nn.Module):
    ...
    # Mainly building convolutional modules for shared networks
    ...
    # Mainly building convolutional modules for specific task networks
    ...
    # Methods required for pcgrad algorithm
